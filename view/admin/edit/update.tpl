...
<form method="post" name="update" action="?a=edit&m=update&dir={$smarty.get.dir}&file={$smarty.get.file}">
	<dl class="form">
		<dd>文件名称：<input type="text" name="name" class="text" value="{$smarty.get.name}" /> </dd>
		<dd><span class="middle">代码编辑：</span><textarea name="info" style="width:90%;height:500px;">{$content}</textarea></dd>
