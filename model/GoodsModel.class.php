...
class GoodsModel extends Model {
	public function __construct() {
		parent::__construct();
		$this->_fields = array('id','nav','brand','name','attr','sn','price_sale','price_market','price_cost','keyword','unit','weight','thumbnail','content','is_up','is_freight','inventory','warn_inventory','sales','service','date');
	...
	public function findDetailsGoods() {
		$_oneGoods = parent::select(array('id','nav','brand','name','thumbnail','thumbnail2','sn','attr','price_sale','price_market','unit','weight','content','is_up','is_freight','inventory','sales','service'), 
